...
class ExpenseAnalysisResponse(BaseModel):
    ...
    top_categories: List[CategoryExpenseResponse] = Field(..., description="Top expense categories")
    summary: dict = Field(..., description="Analysis summary statistics")
    insights: Optional[dict] = Field(None, description="Analysis insights and recommendations")
...
class IncomeVsExpensesResponse(BaseModel):
    ...
    analysis_period: str = Field(..., description="Time period analyzed")
    financial_overview: FinancialOverviewResponse = Field(..., description="Financial overview")
    expense_breakdown: List[dict] = Field(..., description="Top expense categories")
    savings_analysis: SavingsAnalysisResponse = Field(..., description="Savings analysis")
