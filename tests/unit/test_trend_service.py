...
class TestTrendService:
    ...
    @pytest.mark.asyncio
    async def test_analyze_spending_trends_basic(self, trend_service, sample_transactions):
    ...
    async def test_analyze_category_trends(self, trend_service):
        ...
        trend_service.analyze_spending_trends.return_value = {
            ...
            "insights": [
                {"type": "info", "title": "Test insight", "description": "Test", "priority": "low"}
            ]
        }
    ...
    async def test_analyze_income_vs_expense_trends(self, trend_service):
        ...
        mock_income_expense = type('IncomeExpense', (), {
        ...
        mock_transaction_service = AsyncMock()
        mock_transaction_service.get_income_vs_expense.return_value = mock_income_expense
    ...
    def test_generate_trend_insights_decreasing(self, trend_service):
        ...
        assert "progress" in positive["title"].lower() or "decreasing" in positive["description"].lower()
