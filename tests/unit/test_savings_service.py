...
from moneywiz_mcp_server.models.analytics_result import IncomeVsExpenseResult, CategoryExpense
...
class TestSavingsService:
    ...
    async def test_get_savings_recommendations_basic(
        ...
        mock_transaction_service.get_income_vs_expense.return_value = sample_income_expense_data
    ...
    async def test_category_recommendations_high_spending(
        ...
        high_spending_recs = [
            ...
            if r["category"] == "High Spending Category"
        ]
