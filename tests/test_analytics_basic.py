...
def test_transaction_expense_income_classification():
    ...
    expense_data = {"Z_PK": 1, "Z_ENT": 37, "ZACCOUNT2": 1, "ZAMOUNT1": -100.00, 
                   "ZDATE1": 0, "ZDESC2": "Expense", "ZRECONCILED": 0}
    ...
    income_data = {"Z_PK": 2, "Z_ENT": 37, "ZACCOUNT2": 1, "ZAMOUNT1": 100.00,
                  "ZDATE1": 0, "ZDESC2": "Income", "ZRECONCILED": 0}
